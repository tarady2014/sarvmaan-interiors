            ...
            {filteredProjects.map((project, index) => (
              ...
              >
                <div className="relative h-48 md:h-72 rounded-lg overflow-hidden shadow-soft hover:shadow-base transition-shadow bg-gray-200 group">
                  ...
                  <div className="absolute top-3 right-3 bg-secondary text-white px-3 py-1 rounded-full text-xs font-semibold opacity-0 group-hover:opacity-100 transition-opacity">
                    View
                  </div>
                </div>
              </motion.div>
            ...
            >
              ...
              <div className="p-4 md:p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-6">
                  ...
                  <div className="border-l-4 border-secondary pl-4">
                    <p className="text-foreground/60 text-sm">Timeline</p>
                    <p className="text-primary font-semibold">{selectedProject.timeline}</p>
                  </div>
                  {selectedProject.type === 'photo' && (
                    <div className="border-l-4 border-secondary pl-4">
                ...
                {selectedProject.materials && selectedProject.materials.length > 0 && (
                  <div className="mb-6">
                    <h4 className="text-sm font-semibold text-primary mb-3">Materials Used:</h4>
                ...
                <motion.a
                  ...
                  className="block w-full bg-secondary text-white py-4 rounded-lg font-bold text-center hover:bg-secondary/90 transition-colors text-lg"
